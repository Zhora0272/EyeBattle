...
namespace Voodoo.Data
{
    public static class PlayerPrefsUtility
    {
        ...
        public static void SetEncryptedFloat(string key, float value)
        {
            ...
            UnityEngine.PlayerPrefs.SetString(KEY_PREFIX + encryptedKey, VALUE_FLOAT_PREFIX + encryptedValue);
        }
        ...
        public static void SetEncryptedInt(string key, int value)
        {
            ...
            // Store the encrypted key and value (with relevant identifying prefixes) in PlayerPrefs
            UnityEngine.PlayerPrefs.SetString(KEY_PREFIX + encryptedKey, VALUE_INT_PREFIX + encryptedValue);
        }
        ...
        public static void SetEncryptedString(string key, string value)
        {
            ...
            // Store the encrypted key and value (with relevant identifying prefixes) in PlayerPrefs
            UnityEngine.PlayerPrefs.SetString(KEY_PREFIX + encryptedKey, VALUE_STRING_PREFIX + encryptedValue);
        }
        ...
        public static void SetEncryptedBool(string key, bool value)
        {
            ...
            // Store the encrypted key and value (with relevant identifying prefixes) in PlayerPrefs
            UnityEngine.PlayerPrefs.SetString(KEY_PREFIX + encryptedKey, VALUE_BOOL_PREFIX + encryptedValue);
        }
        ...
        public static float GetEncryptedFloat(string key, float defaultValue = 0.0f)
        {
            ...
            string fetchedString = UnityEngine.PlayerPrefs.GetString(encryptedKey);
        ...
        public static T GetEnum<T>(string key, T defaultValue = default(T)) where T : struct
        {
            ...
            string stringValue = UnityEngine.PlayerPrefs.GetString(key);
        ...
        public static void SetDateTime(string key, DateTime value)
        {
            ...
            UnityEngine.PlayerPrefs.SetString(key, value.ToString("o", CultureInfo.InvariantCulture));
        }
