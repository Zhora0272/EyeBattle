...
namespace Vengadores.UIFramework.Components.ScrollExtensions
{
    /// <summary>
    ...
    public class UIInfiniteScroll : MonoBehaviour
    {
        ...
        public void Init()
        {
            if (GetComponent<ScrollRect>() != null)
            {
                ...
                {
                    GameLog.LogError("UI_InfiniteScroll", "Scrolling in both directions not supported, please choose one direction (horizontal or vertical)", this);
                }
            ...
            {
                GameLog.LogError("UI_InfiniteScroll", "No ScrollRect component found", this);
            }
        }
